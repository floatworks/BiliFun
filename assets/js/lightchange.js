/* SlimBox JQuery Plugin Site: https://github.com/binjoo/SlimBox2-for-Typecho */
(function(w) {
    var E = w(window),
    u,
    f,
...
jQuery(document).ready(function($) {
    if (jQuery.fn.emptyInput) jQuery('#searchform input:text').emptyInput();
    $('.my-list').hover(function() {
